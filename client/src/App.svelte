...
<main>
  <div class="hero min-h-screen bg-base-200">
    <div
      class="hero-content flex-col lg:flex-row-reverse max-w-screen-xl gap-8"
    >
      <div class="text-center lg:text-left">
        ...
        <ul class="list-disc">
          ...
          <li>It only knows things that are available in <a class="link" href="https://use.ink">use.ink</a></li>
        </ul>
      </div>
      <div
        class="card flex-shrink-0 w-full max-w-lg shadow-2xl bg-base-100 grow"
      >
